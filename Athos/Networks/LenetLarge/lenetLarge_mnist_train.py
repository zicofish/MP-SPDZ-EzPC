...
def main(_):
  ...
  # [zico] Here, I just construct a fixed batch that is usable to obtain a usable model.^M
  # The model is not fully trained.^M
  ...
  y_conv, keep_prob, evalTensors = deepnn(x)
  ...
  with tf.Session() as sess:
    ...
    print(saver.save(sess, './TrainedModel/lenetLargeModel'))
