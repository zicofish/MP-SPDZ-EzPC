...
def deepnn(x):
  ...
  return y_conv, keep_prob, [W_conv1, b_conv1, W_conv2, b_conv2, W_fc1, b_fc1, W_fc2, b_fc2], [W_conv1]
...
def main(_):
  ...
  y_conv, keep_prob, modelWeights, prTensors = deepnn(x)
  ...
  with tf.Session() as sess:
    ...
    saver.restore(sess, './TrainedModel/lenetLargeModel')
    ...
    DumpTFMtData.dumpImgAndWeightsData2(sess, imagex, 'LenetLarge_mnist_img_' + str(curImageNum) + '.inp', 15)
